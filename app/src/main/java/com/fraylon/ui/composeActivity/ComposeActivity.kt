 ...
 */
package com.fraylon.ui.composeActivity
...
import com.fraylon.workspace.assistant.AssistantScreen
...
import com.fraylon.workspace.assistant.conversation.repository.ConversationRemoteRepositoryImpl
import com.fraylon.workspace.assistant.repository.local.AssistantLocalRepositoryImpl
...
import com.fraylon.ui.ClientIntegrationScreen
import com.fraylon.utils.extensions.getParcelableArgument
import com.fraylon.workspace.R
import com.fraylon.workspace.databinding.ActivityComposeBinding
    ...
    private fun Content(destination: ComposeDestination) {
        ...
        when (currentScreen) {
            is ComposeDestination.AssistantScreen -> {
                val dao = FraylonDatabase.instance().assistantDao()
