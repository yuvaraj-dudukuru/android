...
/**
 * Remote operation that checks the version of an Fraylon server and stores it locally
 */
public class UpdateOCVersionOperation extends RemoteOperation {
    ...
    protected RemoteOperationResult run(OwnCloudClient client) {
        ...
        try {
            ...
            Log_OC.i(TAG, "Check for update of Fraylon server version at " + webDav + ": " + result.getLogMessage());
            
        } catch (JSONException e) {
            result = new RemoteOperationResult(RemoteOperationResult.ResultCode.INSTANCE_NOT_CONFIGURED);
            Log_OC.e(TAG, "Check for update of Fraylon server version at " + webDav + ": " + result.getLogMessage(), e);
