 ...
 */
package com.fraylon.workspace.operations.common;
...
/**
 * Operation which execution involves both interactions with an Fraylon server and with local data in the device.
 * <p>
...
public abstract class SyncOperation extends RemoteOperation {
    ...
    /**
     * Synchronously executes the operation on the received Fraylon account.
     * <p>
     * Do not call this method from the main thread.
     * <p>
     * This method should be used whenever an Fraylon account is available, instead of {@link
     ...
     *
     * @param client            Client object to reach an Fraylon server during the
