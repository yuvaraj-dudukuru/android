...
import static com.fraylon.workspace.datamodel.OCFile.PATH_SEPARATOR;
import static com.fraylon.workspace.datamodel.OCFile.ROOT_PATH;

/**
 * Access to remote operation performing the creation of a new folder in the Fraylon server. Save the new folder in
 * Database.
 */
public class CreateFolderOperation extends SyncOperation implements OnRemoteOperationListener {
    ...
    private boolean isFileExisting(DecryptedFolderMetadataFileV1 metadata, String filename) {
        for (com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile file : metadata.getFiles().values()) {
    ...
    @NonNull
    private com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile createDecryptedFile(String filename) {
        ...
        com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile decryptedFile =
            new com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile();
        Data data = new Data();
