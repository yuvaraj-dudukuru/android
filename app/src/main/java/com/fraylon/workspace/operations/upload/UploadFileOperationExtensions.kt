 ...
 */
package com.fraylon.workspace.operations.upload
...
import com.fraylon.workspace.operations.UploadFileOperation.MISSING_FILE_PERMISSION_NOTIFICATION_ID
...
private fun getActionPendingIntent(context: Context, actionType: UploadFileBroadcastReceiverActions): PendingIntent {
    val intent = Intent(context, UploadFileBroadcastReceiver::class.java).apply {
        action = "com.fraylon.workspace.ACTION_UPLOAD_FILE_PERMISSION"
