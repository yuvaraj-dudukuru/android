...
import com.fraylon.workspace.authentication.AuthenticatorUrlUtils;
...
/**
 * Get basic information from an Fraylon server given its URL.
 * Checks the existence of a configured Fraylon server in the URL, gets its version
...
public class GetServerInfoOperation extends RemoteOperation {
     ...
     * Constructor.
     *
     * @param url               URL to an Fraylon server.
