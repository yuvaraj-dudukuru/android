...
import com.fraylon.workspace.database.entity.SyncedFolderEntityKt;
...
public class SyncedFolderProvider extends Observable {
    ...
    public final SyncedFolderDao dao = FraylonDatabase.getInstance(MainApp.getAppContext()).syncedFolderDao();
