...
import com.fraylon.model.ShareeEntry;
import com.fraylon.utils.date.DateFormatPattern;
import com.fraylon.utils.extensions.DateExtensionsKt;
...
import com.fraylon.workspace.operations.RemoteOperationFailedException;
...
public class FileDataStorageManager {
    ...
    public final RecommendedFileDao recommendedFileDao = FraylonDatabase.getInstance(MainApp.getAppContext()).recommendedFileDao();
    public final OfflineOperationDao offlineOperationDao = FraylonDatabase.getInstance(MainApp.getAppContext()).offlineOperationDao();
    public final FileDao fileDao = FraylonDatabase.getInstance(MainApp.getAppContext()).fileDao();
    public final ShareDao shareDao = FraylonDatabase.getInstance(MainApp.getAppContext()).shareDao();
