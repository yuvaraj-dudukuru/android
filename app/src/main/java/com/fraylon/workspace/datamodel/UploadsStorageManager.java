...
public class UploadsStorageManager extends Observable {
    ...
    public final UploadDao uploadDao = FraylonDatabase.getInstance(MainApp.getAppContext()).uploadDao();
     ...
     * @param remotePath path of the file to upload in the Fraylon storage
