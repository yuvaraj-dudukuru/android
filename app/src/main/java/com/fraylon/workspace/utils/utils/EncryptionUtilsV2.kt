...
import com.fraylon.utils.extensions.showToast
...
import com.fraylon.workspace.datamodel.e2e.v2.encrypted.EncryptedMetadata
import com.fraylon.workspace.datamodel.e2e.v2.encrypted.EncryptedUser
...
import com.fraylon.workspace.operations.UploadException
...
//
    ...
    @VisibleForTesting
    fun migrateDecryptedFileV1ToV2(v1: com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile): DecryptedFile =
        DecryptedFile(
