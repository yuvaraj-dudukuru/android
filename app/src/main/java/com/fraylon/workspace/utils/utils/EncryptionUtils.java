...
import com.fraylon.workspace.datamodel.EncryptedFiledrop;
...
//    }
    ...
    public static Pair<Boolean, DecryptedFolderMetadataFile> retrieveMetadata(OCFile parentFile,
        ...
        if (getMetadataOperationResult.isSuccess()) {
            ...
            // new metadata
            metadata = new DecryptedFolderMetadataFile(new com.fraylon.workspace.datamodel.e2e.v2.decrypted.DecryptedMetadata(),
                                                       new ArrayList<>(),
                                                       new HashMap<>(),
