...
import com.fraylon.workspace.databinding.FileDetailsActivitiesFragmentBinding;
...
import com.fraylon.workspace.operations.CommentFileOperation;
import com.fraylon.workspace.ui.activity.ComponentsGetter;
import com.fraylon.workspace.ui.activities.adapter.ActivityAndVersionListAdapter;
import com.fraylon.workspace.ui.events.CommentsEvent;
import com.fraylon.workspace.ui.helpers.FileOperationsHelper;
import com.fraylon.workspace.ui.interfaces.ActivityListInterface;
import com.fraylon.workspace.ui.interfaces.VersionListInterface;
...
public class FileDetailActivitiesFragment extends Fragment implements
    ...
    private OwnCloudClient NextcloudClient;
    ...
    private void fetchAndSetData(long lastGiven) {
        ...
        Thread t = new Thread(() -> {
            try {
                NextcloudClient = clientFactory.create(user);
                ...
                if (restoreFileVersionSupported) {
                    ...
                    final var result1 = readFileVersionsOperation.execute(NextcloudClient);
        ...
        new Thread(() -> {
            if (file.getUnreadCommentsCount() > 0) {
                MarkCommentsAsReadRemoteOperation unreadOperation = new MarkCommentsAsReadRemoteOperation(
                    file.getLocalId());
                RemoteOperationResult remoteOperationResult = unreadOperation.execute(NextcloudClient);
