...
import com.fraylon.workspace.databinding.FilesFolderPickerBinding
import com.fraylon.workspace.databinding.FilesPickerBinding
...
import com.fraylon.workspace.utils.PathUtils
...
open class FolderPickerActivity :
    ...
    companion object {
        const val EXTRA_FOLDER = "com.fraylon.workspace.ui.activity.FolderPickerActivity".plus(".EXTRA_FOLDER")
