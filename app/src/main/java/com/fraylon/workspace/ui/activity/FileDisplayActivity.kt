...
import com.fraylon.workspace.files.DeepLinkHandler
...
import com.fraylon.workspace.jobs.folderDownload.FolderDownloadEventBroadcaster
import com.fraylon.workspace.jobs.upload.FileUploadEventBroadcaster
import com.fraylon.workspace.jobs.upload.FileUploadHelper
import com.fraylon.workspace.jobs.upload.FileUploadWorker
import com.fraylon.workspace.media.PlayerServiceConnection
...
import com.fraylon.model.WorkerState.OfflineOperationsCompleted
import com.fraylon.ui.composeActivity.ComposeProcessTextAlias
import com.fraylon.utils.extensions.getParcelableArgument
import com.fraylon.utils.extensions.isActive
import com.fraylon.utils.extensions.lastFragment
import com.fraylon.utils.extensions.logFileSize
import com.fraylon.utils.extensions.navigateToAllFiles
import com.fraylon.utils.extensions.observeWorker
import com.fraylon.utils.fileNameValidator.FileNameValidator.checkFolderPath
import com.fraylon.utils.view.FastScrollUtils
import com.fraylon.workspace.MainApp
import com.fraylon.workspace.R
import com.fraylon.workspace.databinding.FilesBinding
...
import com.fraylon.workspace.datamodel.VirtualFolderType
...
import com.fraylon.workspace.operations.CopyFileOperation
import com.fraylon.workspace.operations.CreateFolderOperation
import com.fraylon.workspace.operations.DownloadType
import com.fraylon.workspace.operations.MoveFileOperation
...
import com.fraylon.workspace.syncadapter.FileSyncAdapter
import com.fraylon.workspace.ui.CompletionCallback
import com.fraylon.workspace.ui.asynctasks.CheckAvailableSpaceTask
import com.fraylon.workspace.ui.asynctasks.CheckAvailableSpaceTask.CheckAvailableSpaceListener
import com.fraylon.workspace.ui.asynctasks.FetchRemoteFileTask
import com.fraylon.workspace.ui.asynctasks.GetRemoteFileTask
import com.fraylon.workspace.ui.dialog.DeleteBatchTracker
import com.fraylon.workspace.ui.dialog.SendShareDialog.SendShareDialogDownloader
import com.fraylon.workspace.ui.dialog.SortingOrderDialogFragment.OnSortingOrderListener
...
import com.fraylon.workspace.ui.events.SearchEvent
import com.fraylon.workspace.ui.events.SyncEventFinished
import com.fraylon.workspace.ui.events.TokenPushEvent
import com.fraylon.workspace.ui.fragment.EmptyListState
...
import com.fraylon.workspace.ui.fragment.SearchType
import com.fraylon.workspace.ui.fragment.SharedListFragment
import com.fraylon.workspace.ui.fragment.TaskRetainerFragment
...
import com.fraylon.workspace.ui.helpers.UriUploader
import com.fraylon.workspace.ui.interfaces.TransactionInterface
...
import com.fraylon.workspace.ui.preview.PreviewMediaFragment.Companion.newInstance
...
import com.fraylon.workspace.ui.preview.pdf.PreviewPdfFragment.Companion.newInstance
import com.fraylon.workspace.utils.DataHolderUtil
...
import com.fraylon.workspace.utils.PermissionUtil.requestNotificationPermission
import com.fraylon.workspace.utils.PermissionUtil.requestStoragePermissionIfNeeded
import com.fraylon.workspace.utils.PushUtils
import com.fraylon.workspace.utils.StringUtils
import com.fraylon.workspace.utils.UriUtils
...
/**
 * Displays, what files the user has available in his Fraylon. This is the main view.
 */
@Suppress(
    "ComplexCondition",
    "SpreadOperator",
...
class FileDisplayActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTheme(R.style.Theme_Fraylon_Toolbar_Drawer)
    ...
    private fun checkStoragePath() {
        ...
        if (!preferences.isStoragePathValid() && !File(storagePath).exists()) {
            ...
            try {
                val builder = MaterialAlertDialogBuilder(this, R.style.Theme_Fraylon_Dialog)
    ...
    private fun upgradeNotificationForInstantUpload() {
        ...
        if (preferences.instantPictureUploadEnabled() || preferences.instantVideoUploadEnabled()) {
            ...
            // show info pop-up
            MaterialAlertDialogBuilder(this, R.style.Theme_Fraylon_Dialog).setTitle(R.string.drawer_synced_folders)
                .setMessage(
    ...
    companion object {
        ...
        const val ACTION_DETAILS: String = "com.fraylon.workspace.ui.activity.action.DETAILS"
