...
import com.fraylon.workspace.databinding.SortingOrderFragmentBinding
...
class SortingOrderDialogFragment :
    ...
    companion object {
        ...
        fun newInstance(sortOrder: FileSortOrder): SortingOrderDialogFragment {
            ...
            dialogFragment.setStyle(STYLE_NORMAL, R.style.Theme_Fraylon_Dialog)
