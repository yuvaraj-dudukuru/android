...
/**
 * Activity reporting errors occurred when local files uploaded to an Fraylon account with an app
 * in version under 1.3.16 where being copied to the Fraylon local folder.
 * Allows the user move the files to the Fraylon local folder. let them unlinked to the remote files.
...
public class ErrorsWhileCopyingHandlerActivity  extends AppCompatActivity implements OnClickListener {
    ...
    /**
     * Asynchronous task performing the move of all the local files to the Fraylon folder.
     */
