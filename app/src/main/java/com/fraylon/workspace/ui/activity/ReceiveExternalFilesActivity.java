...
import com.fraylon.utils.fileNameValidator.FileNameTextWatcher;
import com.fraylon.utils.fileNameValidator.FileNameValidator;
import com.fraylon.workspace.MainApp;
import com.fraylon.workspace.R;
import com.fraylon.workspace.databinding.ReceiveExternalFilesBinding;
import com.fraylon.workspace.databinding.UploadFileDialogBinding;
...
import com.fraylon.workspace.ui.adapter.ReceiveExternalFilesAdapter;
import com.fraylon.workspace.ui.asynctasks.CopyAndUploadContentUrisTask;
...
import static com.fraylon.workspace.utils.UriUtils.getDisplayNameForUri;

/**
 * This can be used to upload things to an Fraylon instance.
 */
public class ReceiveExternalFilesActivity extends FileActivity
    ...
    protected void setAccount(Account account, boolean savedAccount) {
        ...
        if (accounts.length == 0) {
            Log_OC.i(TAG, "No Fraylon account is available");
