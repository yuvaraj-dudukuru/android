...
import com.fraylon.utils.extensions.ActivityExtensionsKt;
import com.fraylon.utils.extensions.BundleExtensionsKt;
import com.fraylon.utils.extensions.FileExtensionsKt;
import com.fraylon.utils.extensions.IntentExtensionsKt;
...
import com.fraylon.workspace.operations.CreateShareViaLinkOperation;
import com.fraylon.workspace.operations.CreateShareWithShareeOperation;
import com.fraylon.workspace.operations.GetSharesForFileOperation;
import com.fraylon.workspace.operations.SetFilesDownloadLimitOperation;
...
import com.fraylon.workspace.operations.UnshareOperation;
import com.fraylon.workspace.operations.UpdateNoteForShareOperation;
import com.fraylon.workspace.operations.UpdateShareInfoOperation;
import com.fraylon.workspace.operations.UpdateSharePermissionsOperation;
import com.fraylon.workspace.operations.UpdateShareViaLinkOperation;
...
import com.fraylon.workspace.ui.asynctasks.CheckRemoteWipeTask;
import com.fraylon.workspace.ui.asynctasks.LoadingVersionNumberTask;
import com.fraylon.workspace.ui.dialog.ConfirmationDialogFragment;
import com.fraylon.workspace.ui.dialog.LoadingDialog;
import com.fraylon.workspace.ui.dialog.ShareLinkToDialog;
import com.fraylon.workspace.ui.dialog.SslUntrustedCertDialog;
import com.fraylon.workspace.ui.events.DialogEvent;
import com.fraylon.workspace.ui.events.DialogEventType;
import com.fraylon.workspace.ui.events.FavoriteEvent;
...
import com.fraylon.workspace.ui.fragment.filesRepository.FilesRepository;
import com.fraylon.workspace.ui.fragment.filesRepository.RemoteFilesRepository;
...
import static com.fraylon.workspace.ui.activity.FileDisplayActivity.TAG_PUBLIC_LINK;

/**
 * Activity with common behaviour for activities handling {@link OCFile}s in Fraylon {@link Account}s .
 */
public abstract class FileActivity extends DrawerActivity
    ...
    public static final String EXTRA_FILE = "com.fraylon.workspace.ui.activity.FILE";
    public static final String EXTRA_FILE_REMOTE_PATH = "com.fraylon.workspace.ui.activity.FILE_REMOTE_PATH";
    public static final String EXTRA_LIVE_PHOTO_FILE = "com.fraylon.workspace.ui.activity.LIVE.PHOTO.FILE";
    public static final String EXTRA_USER = "com.fraylon.workspace.ui.activity.USER";
    public static final String EXTRA_FROM_NOTIFICATION = "com.fraylon.workspace.ui.activity.FROM_NOTIFICATION";
    public static final String APP_OPENED_COUNT = "APP_OPENED_COUNT";
    public static final String EXTRA_SEARCH = "com.fraylon.workspace.ui.activity.SEARCH";
    public static final String EXTRA_SEARCH_QUERY = "com.fraylon.workspace.ui.activity.SEARCH_QUERY";
    ...
    /**
     * Loads the Fraylon {@link Account} and main {@link OCFile} to be handled by the instance of
     * the {@link FileActivity}.
     *
     * Grants that a valid Fraylon {@link Account} is associated to the instance, or that the user
