...
open class ConfirmationDialogFragment :
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val defaultTitleIconId = com.fraylon.workspace.R.drawable.ic_warning
        ...
        if (titleIconId == defaultTitleIconId) {
            ...
            val icon = ContextCompat.getDrawable(requireContext(), titleIconId)?.apply {
                setTint(requireContext().getColor(com.fraylon.workspace.R.color.text_color))
            }
    ...
    companion object {
        ...
        fun newInstance(
            ...
            titleResId: Int,
            titleIconId: Int = com.fraylon.workspace.R.drawable.ic_warning,
