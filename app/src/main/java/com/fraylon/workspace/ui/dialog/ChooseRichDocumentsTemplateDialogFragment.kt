...
import com.fraylon.workspace.databinding.ChooseTemplateBinding
import com.fraylon.workspace.datamodel.FileDataStorageManager
import com.fraylon.workspace.datamodel.OCFile
import com.fraylon.workspace.datamodel.Template
import com.fraylon.workspace.files.CreateFileFromTemplateOperation
import com.fraylon.workspace.files.FetchTemplateOperation
...
import com.fraylon.workspace.ui.adapter.RichDocumentsTemplateAdapter
import com.fraylon.workspace.ui.dialog.IndeterminateProgressDialog.Companion.newInstance
import com.fraylon.workspace.utils.DisplayUtils
import com.fraylon.workspace.utils.FileStorageUtils
import com.fraylon.workspace.utils.KeyboardUtils
import com.fraylon.workspace.utils.FraylonServer
...
class ChooseRichDocumentsTemplateDialogFragment :
    ...
    companion object {
        ...
        @JvmStatic
        @FraylonServer(max = 18) // will be removed in favor of generic direct editing
