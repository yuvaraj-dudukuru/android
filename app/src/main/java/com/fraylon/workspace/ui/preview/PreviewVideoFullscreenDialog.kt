...
import com.fraylon.workspace.media.FraylonExoPlayer
import com.nextcloud.common.NextcloudClient
import com.fraylon.workspace.databinding.DialogPreviewVideoBinding
...
class PreviewVideoFullscreenDialog(
    ...
    private fun getExoPlayer(nextcloudClient: NextcloudClient): ExoPlayer = if (shouldUseRotatedVideoWorkaround) {
        ...
        FraylonExoPlayer
            .createFraylonExoplayer(sourceView.context, nextcloudClient)
            .apply {
