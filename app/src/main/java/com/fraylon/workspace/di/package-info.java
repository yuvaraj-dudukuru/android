 ...
 * first registered in {@link com.fraylon.workspace.di.ComponentsModule} class.
 * <p>
 * {@link com.fraylon.workspace.di.ComponentsModule} will be used by Dagger compiler to
 * create an injector for a given class.
 *
 * @see com.fraylon.workspace.di.InjectorNotFoundException
