 ...
 * {@link com.fraylon.workspace.services.OperationsService#onCreate()}.
 */
class SyncFolderHandler extends Handler {
    ...
    /**
     * Returns True when the folder located in 'remotePath' in the Fraylon account 'account', or any of its
     ...
     *
     * @param account       Fraylon {@link Account} where the remote file is stored.
