 ...
 */
package com.fraylon.workspace.services;
...
import com.fraylon.workspace.operations.CheckCurrentCredentialsOperation;
...
public class OperationsService extends Service {
    ...
    public class OperationsServiceBinder extends Binder /* implements OnRemoteOperationListener */ {
         ...
         *
         * @param account Fraylon account where the remote folder is stored.
        ...
        /**
         * Returns True when the file described by 'file' in the Fraylon account 'account' is downloading or waiting to
         * download.
         * <p>
    ...
    private static class ServiceHandler extends Handler {
        ...
        private void nextOperation() {
            ...
            if (next != null) {
                ...
                try {
                    /// prepare client object to send the request to the Fraylon server
