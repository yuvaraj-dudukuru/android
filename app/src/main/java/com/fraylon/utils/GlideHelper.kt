...
import com.fraylon.utils.LinkHelper.validateAndGetURL
import com.owncloud.android.lib.common.utils.Log_OC
import com.fraylon.workspace.utils.svg.SvgSoftwareLayerSetter
...
object GlideHelper {
    ...
    private fun createGlideUrl(url: String, client: NextcloudClient) = GlideUrl(
        ...
        LazyHeaders.Builder()
            ...
            .addHeader("User-Agent", "Mozilla/5.0 (Android) Fraylon-android")
            .build()
    )
