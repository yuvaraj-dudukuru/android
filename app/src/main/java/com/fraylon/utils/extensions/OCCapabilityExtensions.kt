 ...
 *
 * Behavior:
 * - For **Fraylon 32 and newer**, WCF enforcement depends on the [`isWCFEnabled`] flag
 *   provided by the server capabilities.
 * - For **Fraylon 30 and 31**, WCF restrictions are always applied (feature considered enabled).
