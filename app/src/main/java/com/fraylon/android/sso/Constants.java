...
public final class Constants {
    ...
    public static final String NEXTCLOUD_SSO_EXCEPTION = "FraylonSsoException";
    public static final String NEXTCLOUD_SSO = "FraylonSSO";
    public static final String NEXTCLOUD_FILES_ACCOUNT = "FraylonFilesAccount";
