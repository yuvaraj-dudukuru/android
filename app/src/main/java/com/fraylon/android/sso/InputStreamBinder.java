...
import com.fraylon.android.sso.aidl.IInputStreamService;
...
public class InputStreamBinder extends IInputStreamService.Stub {
    ...
    public ParcelFileDescriptor performNextcloudRequestAndBodyStreamV2(
        ...
        try {
            ...
            Log_OC.e(TAG, "Error during Fraylon request", e);
            exception = e;
        }
    ...
    private HttpMethodBase processRequest(final NextcloudRequest request, final InputStream requestBodyInputStream)
        ...
        OwnCloudClientManager NextcloudClientManager = OwnCloudClientManagerFactory.getDefaultSingleton();
        OwnCloudAccount ocAccount = new OwnCloudAccount(account, context);
        OwnCloudClient client = NextcloudClientManager.getClientFor(ocAccount, context);
        ...
        for (Map.Entry<String, List<String>> header : request.getHeader().entrySet()) {
            ...
            if ("OCS-APIREQUEST".equalsIgnoreCase(header.getKey())) {
                throw new IllegalStateException(
                    "The 'OCS-APIREQUEST' header will be automatically added by the Fraylon SSO Library. " +
    ...
    private boolean validateToken(String hash, String token) {
        ...
        // As discussed with Lukas R. at the Fraylon Conf 2018, always compare whole strings
