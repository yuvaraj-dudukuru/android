...
class FileUploadHelperTest {
    ...
    private fun toggleWCFRestrictions(value: Boolean) {
        ...
        val mockFileStorageManager = mockk<com.fraylon.workspace.datamodel.FileDataStorageManager>(relaxed = true)
    ...
    fun setUp() {
        ...
        val uploadsStorageManager = mockk<com.fraylon.workspace.datamodel.UploadsStorageManager>(relaxed = true)

        val daoField = com.fraylon.workspace.datamodel.UploadsStorageManager::class.java
            .declaredFields
