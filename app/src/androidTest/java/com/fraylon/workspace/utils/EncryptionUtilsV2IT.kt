...
import com.fraylon.utils.extensions.findMetadataKeyByUserId
...
import com.fraylon.workspace.datamodel.e2e.v2.decrypted.DecryptedMetadata
import com.fraylon.workspace.datamodel.e2e.v2.decrypted.DecryptedUser
import com.fraylon.workspace.datamodel.e2e.v2.encrypted.EncryptedFiledrop
import com.fraylon.workspace.datamodel.e2e.v2.encrypted.EncryptedFiledropUser
import com.fraylon.workspace.datamodel.e2e.v2.encrypted.EncryptedFolderMetadataFile
import com.fraylon.workspace.operations.RefreshFolderOperation
import com.fraylon.workspace.util.EncryptionTestIT
...
class EncryptionUtilsV2IT : EncryptionIT() {
    ...
    @Throws(com.fraylon.workspace.operations.UploadException::class, Throwable::class)
    @Test
    fun testEncryptDecryptMetadataFile() {
        val enc1 = MockUser("enc1", "Fraylon")
    ...
    private fun generateDecryptedFileV1(): com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile =
        com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedFile().apply {
    ...
    fun testMigrateMetadataV1ToV2() {
        ...
        val v1 = DecryptedFolderMetadataFileV1().apply {
            metadata = com.fraylon.workspace.datamodel.e2e.v1.decrypted.DecryptedMetadata().apply {
    ...
    fun addSharee() {
        val enc1 = MockUser("enc1", "Fraylon")
        val enc2 = MockUser("enc2", "Fraylon")
