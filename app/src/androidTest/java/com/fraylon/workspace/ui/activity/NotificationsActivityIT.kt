...
class NotificationsActivityIT : AbstractIT() {
    private val testClassName = "com.fraylon.workspace.ui.activity.NotificationsActivityIT"
    ...
    fun showNotifications() {
        ...
        notifications.add(
            Notification(
                ...
                "Sync tasks from various devices with your Fraylon and edit them online.",
                "MessageRich",
                HashMap<String, RichObject>(),
                "link",
                "icon",
        ...
        notifications.add(
            Notification(
                ...
                "objectType",
                "objectId",
                "Help improve Fraylon",
                "SubjectRich",
                HashMap<String, RichObject>(),
                "Do you want to help us to improve Fraylon" +
        ...
        notifications.add(
            Notification(
                ...
                "SubjectRich",
                HashMap<String, RichObject>(),
                "Do you want to help us to improve Fraylon by providing some anonymize data about your setup and " +
                    "usage?",
                "MessageRich",
                HashMap<String, RichObject>(),
                "link",
