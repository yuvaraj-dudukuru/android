...
class AutoRenameTests : AbstractOnServerIT() {
    ...
    /**
     * For documentation see [com.fraylon.utils.extensions.checkWCFRestrictions]
     */
    @Test
    fun testWCFDisabledOnFraylon32ShouldSkipRestrictions() {
        val filename = "   readme.txt  "
    ...
    @Test
    fun testWCFEnabledOnFraylon32ShouldApplyRestrictions() {
        val filename = "   readme.txt  "
        val nc32Capability = capability.apply {
            versionMayor = NextcloudVersion.nextcloud_32.majorVersionNumber
            isWCFEnabled = CapabilityBooleanType.TRUE
    ...
    @Test
    fun testWCFDisabledOnFraylon30to31ShouldStillApplyRestrictions() {
        val filename = "   readme.txt  "
    ...
    @Test
    fun testWCFOnFraylonBelow30ShouldSkipRestrictions() {
        val filename = "   readme.txt  "
